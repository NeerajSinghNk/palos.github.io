...
<html>
	<head>
		...
		<script src="java_script/deleteBook.js"></script>
		<script src="java_script/DeleteTitle.js"></script>
...
<%
	System.out.println("Delete_Book_Data.jsp");
	...
	if(user!=null)
	{
		...
		try
		{
			...
			System.out.println("Delete_Book_Data.jsp---->"+query);
		
			out.println("<form method='post' action='DeleteBookData.jsp'>");
			out.println("<label for='bt'>Book Type</label>");
			out.println("<select id='book1' name='book1' onchange='deleteBookDetail()'>");
		...
		out.println("<select id='bid1' name='bid1' onchange='DeleteTit()'>");
				out.println("<option>select</option>");
		out.println("</select>");
	
			out.println("<input type='submit' value='Delete'>");
			out.println("<div id='up1'></div>");
			out.println("</form>");
...
<%
	String dsd=(String)session.getAttribute("dd");
	//System.out.println("*****************"+dsd);
	if(dsd!=null)
	{
		out.println("<span style='color:red; font-size:20px;' name='msg' id='msg'>Successfully deleted..."+dsd+"</span>");
		
		session.removeAttribute("dsd");
	}
